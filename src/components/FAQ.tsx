...
const faqItems = [
  ...
  "<div><p class='faq-question'>How fast will I see noticeable results?</p><p class='faq-answer'>Initial balancing begins during the Calm phase within 21 days, followed by structural clearing over the 90-day protocol.</p></div>",
  "<div><p class='faq-question'>Can I integrate my existing products?</p><p class='faq-answer'>Yes. The framework is designed to order your process, not replace every bottle. It integrates seamlessly with your favorite steps.</p></div>",
